...
app.config['SQLALCHEMY_DATABASE_URI'] = "mysql+pymysql://root:Zoubair@2024@localhost/Local DB"
...
def recommendations():
    if request.method == 'POST':
        ...
        nbr = int(request.form.get('nbr', 10))  # Default to 10 if 'nbr' is not provided
        content_based_rec = content_based_recommendations(train_data, prod, top_n=nbr)

        # Create a list of random image URLs for the recommendations
        ...
        if content_based_rec.empty:
            ...
            return render_template('main.html',
                                   message=message,
                                   content_based_rec=content_based_rec,  # Empty DataFrame
